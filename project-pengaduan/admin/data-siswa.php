...
<div class="bottom-nav">
    <div class="bottom-nav-container">
        ...
        <a href="list_aspirasi.php" class="bottom-nav-item">
            <i class="bi bi-list-check"></i>
            <span>List</span>
        </a>
        <a href="histori-aspirasi.php" class="bottom-nav-item">
            <i class="bi bi-clock-history"></i>
            <span>Histori</span>
        </a>
        <a href="data-siswa.php" class="bottom-nav-item active">
            <i class="bi bi-people-fill"></i>
            <span>Siswa</span>
        </a>
        <a href="daftarfeedback.php" class="bottom-nav-item">
            <i class="bi bi-chat-dots-fill"></i>
            <span>Chat</span>
        </a>
        <a href="progresperbaikan.php" class="bottom-nav-item">
