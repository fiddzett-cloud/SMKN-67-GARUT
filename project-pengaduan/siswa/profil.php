...
<body class="bg-gray-100 text-[#1F2937]">

<div class="flex min-h-screen">

    <!-- SIDEBAR -->
    <aside class="w-64 bg-[#38BDF8] text-white flex flex-col">
        <div class="flex items-center gap-3 px-6 py-5 border-b border-white/20">
            <img src="../img/logo1.png" class="h-10" alt="Logo">
            <span class="text-lg font-bold">SuaraSiswa</span>
        </div>

        <nav class="flex-1 px-4 py-6 space-y-2">
            <a href="dashboard.php" class="block px-4 py-2 rounded-lg hover:bg-[#0EA5E9]">Dashboard</a>
            <a href="data-aspirasi.php" class="block px-4 py-2 rounded-lg hover:bg-[#0EA5E9]">List Aspirasi</a>
            <a href="data-siswa.php" class="block px-4 py-2 rounded-lg hover:bg-[#0EA5E9]">Data Siswa</a>
            <a href="daftarfeedback.php" class="block px-4 py-2 rounded-lg hover:bg-[#0EA5E9]">Feedback</a>
            <a href="sarana.php" class="block px-4 py-2 rounded-lg hover:bg-[#0EA5E9]">Sarana</a>
            <a href="histori-aspirasi.php" class="block px-4 py-2 rounded-lg hover:bg-[#0EA5E9]">Histori</a>
            <a href="profil.php" class="block px-4 py-2 rounded-lg bg-[#0EA5E9]">Profil</a>
        </nav>
