...
// Jika belum ada, kita gunakan fallback 'Siswa'
...
<nav class="bg-white border-b border-gray-200 shadow-sm sticky top-[65px] z-30">
    <div class="max-w-7xl mx-auto px-4 flex space-x-8 h-14 items-center">
        <a href="dashboard.php" class="nav-item flex items-center h-full px-2 text-sm font-medium text-gray-500">
        ...
        <a href="histori-aspirasi.php" class="nav-item active flex items-center h-full px-2 text-sm font-medium">
